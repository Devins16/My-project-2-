...
public class TextArchitect
{
    ...
    // Append text to what is already in the text arhcitect
    ...
    private void Prepare_Fade()
    {
        ...
        for(int i = 0; i < textInfo.characterCount; i++)
        {
            ...
            // Add flickers effect at the first character in the dialogue text
    ...
    // Control speed of text typewriter each time the key press down
