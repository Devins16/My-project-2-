...
public class AudioManager1 : MonoBehaviour
{
    ...
    public static AudioManager1 instance { get; private set; } // Change to AudioManager1
    ...
    public AudioSource PlaySoundEffect(string filePath, AudioMixerGroup mixer = null, float volume = 1, float pitch = 1, bool loop = false)
    {
        ...
        if (clip == null)
        {
            Debug.LogError($"Could not load audio file '{filePath}'. Please ensure it exists within Resources!");
            return null;
        }
